    ...
    <header>
      <nav className="bg-white border-b border-gray-200 dark:bg-gray-900 dark:border-gray-900">
        <div className="flex flex-wrap items-center justify-between max-w-screen-xl p-4 mx-auto">
          ...
          >
            <img src={Logo} className="h-8" alt="MovieSpot Logo" />
          ...
          <div id="mobileNav" className="flex md:order-2">
            {/* {If user click darkmode button it will change from true to false or in vice versa } */}
            <button
              onClick={() => setDarkMode(!darkMode)}
              data-tooltip-target="navbar-search-example-toggle-dark-mode-tooltip"
              type="button"
              data-toggle-dark="light"
              className="flex items-center p-2 mr-2 text-xs font-medium text-gray-700 bg-white rounded-lg toggle-dark-state-example hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-gray-300 dark:focus:ring-gray-500 dark:bg-transparent focus:outline-none dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
            >
              {darkMode ? (
                <svg
                  aria-hidden="true"
            ...
            {/* {If user click Search button or sanduich button then hidden will be the opposite and will open/close } */}
            <button
            ...
            <div className="relative hidden md:block">
              ...
              {/* Wrap input field into a form and add a name ex 'search' and add to form onSubmit to do sth*/}
